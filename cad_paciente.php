          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                <div class="card-body">
                <form action="bd/cadastro.php?type=paciente&ra=<?php echo $ra; ?>" method="POST" class="mt-4">
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      <label for="inputText" class="col-sm-2 col-form-label">2 Telefone:</label>
                      <div class="col-sm-10">
                        <input type="tel" class="form-control" id="tel2" name="tel2" required>
                      </div>
                    </div>

                    <div class="row mb-3">
                      <label for="inputText" class="col-sm-2 col-form-label">Clínica:</label>
                      <div class="col-sm-10">
