...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Cadastro de professor/ADM</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="inicio_aluno.php?ra=<?php echo $ra; ?>.html">Home</a></li>
          <li class="breadcrumb-item active">Cadastro de professor-ADM</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                <div class="card-body">
                <form action="bd/cadastro.php?type=professor&ra=<?php echo $ra; ?>" method="POST" onsubmit="return validateForm()" class="mt-4">
                    <div class="row mb-3">
                      <label for="inputText" class="col-sm-2 col-form-label">Código do Professor:</label>
                      <div class="col-sm-10">
