    ...
    <section class="section dashboard">
      ...
      <div class="col-lg-8">
        <div class="col-8">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Escolha a Máteria</h5>
                <ul class="list-group">
                  <?php foreach ($matarias as $materia) : ?>
                    <li class="list-group-item"><i class="bi bi-caret-right me-1 text-success"></i><a class="fw-bold text-dark" href="prox_paciente_2.php?ra=<?php echo $ra; ?>&materia_id=<?php echo $materia['ID']; ?>"><?php echo $materia['NomeMateria']; ?></a></li>
                  <?php endforeach; ?>
                </ul>
            </div>
          </div>
