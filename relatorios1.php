              ...
              <h5 class="card-title">Escolha a Máteria</h5>
                <ul class="list-group">
                  <?php foreach ($matarias as $materia) : ?>
                    <li class="list-group-item"><i class="bi bi-caret-right me-1 text-success"></i><a href="relatorios2.php?tipo=<?php echo $tipo; ?>&materia_id=<?php echo $materia['ID']; ?>&ra=<?php echo $ra ?>"><?php echo $materia['NomeMateria']; ?></a></li>
                  <?php endforeach; ?>
                </ul>
            </div>
          </div>
