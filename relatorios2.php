    ...
    <section class="section dashboard">
      ...
      <div class="col-lg-8">
        <div class="col-8">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Itens Vinculados à Matéria</h5>
                <ul class="list-group">
                  <?php
                    if ($tipo == "aluno") :
                  ...
                  ?>
                        <li class="list-group-item"><i class="bi bi-caret-right me-1 text-success"></i>
                          <a href="relatorios3.php?id=<?php echo $aluno['RA']; ?>&tipo=aluno&ra=<?php echo $ra; ?>">
                            <?php echo $aluno['RA']; ?> - <?php echo $aluno['Nome']; ?>
                          </a>
                        </li>
                    <?php
                      endforeach;
                    ...
                    ?>
                        <li class="list-group-item"><i class="bi bi-caret-right me-1 text-success"></i>
                          <a href="relatorios3.php?id=<?php echo $paciente['ID']; ?>&tipo=<?php echo $tipo; ?>&ra=<?php echo $ra; ?>">
                            <?php echo $paciente['ID']; ?> - <?php echo $paciente['Nome']; ?>
                          </a>
                        </li>
                    <?php
                      endforeach;
